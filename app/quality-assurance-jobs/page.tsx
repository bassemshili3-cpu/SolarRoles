...
export default async function QualityAssuranceJobsPage({ searchParams }: any) {
 ...
 const [{ count }, initialData] = await Promise.all([
  getCachedJobCount(params.what || 'quality assurance', params.where || '', params.salary_min),
  searchJobs({ what: params.what || 'quality assurance', where: params.where || '', results_per_page: 30, page: 1 })
