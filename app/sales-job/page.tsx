...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Sales Jobs | Urgently Hiring Across the US',
    description:
  ...
  twitter: {
    ...
    title: 'Sales Jobs | Positions Needed ASAP Nationwide',
    description:
...
export default async function SalesJobPage({ searchParams }: any) {
  ...
  getMergedJobCount(params.what || 'sales', params.where || '', params.salary_min ? Number(params.salary_min) : undefined),
