...
export default async function SchoolBusDriverJobsPage({ searchParams }: any) {
  ...
  const [{ count }, initialData] = await Promise.all([
    getCachedJobCount(params.what || 'school bus driver', params.where || '', params.salary_min),
    searchJobs({ what: params.what || 'school bus driver', where: params.where || '', results_per_page: 30, page: 1 })
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <header className="mb-10">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">
            {count > 0 ? count.toLocaleString() : 'Thousands of'} School Bus Driver Jobs Available Across the United States
          </h1>
        </header>
