...
import { ROLES, SALARY_TO_LANDING, titleFilterPrisma, titleFilterSql, getRoleSalaryStats } from '@/lib/roleSalary'

export const revalidate = 86400


// Roles + filtres + calculs de salaire centralises dans lib/roleSalary.ts
...
export default async function SalaryReportPage({
  ...
  // National average (shared lib/roleSalary.ts)
  const nationalStats = await getRoleSalaryStats(slug)
  const nationalAvg = nationalStats?.midpoint ?? 0
  const totalListings = nationalStats?.count ?? 0
