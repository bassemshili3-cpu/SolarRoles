...
export default async function SalaryReportPage({
  ...
  // Le LOWER + LIKE capture toutes les variantes du titre (Senior, Apprentice, Lead, etc.)
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <header className="mb-12">
          ...
          <p className="text-gray-500 max-w-2xl">
            ...
            Average listed salary for {jobTitle} positions across the United States, computed from {fmt(totalListings)} active solar job listings. States with fewer than 3 listings are excluded for accuracy.
        ...
        <section className="mt-16 bg-[#F0F9FF] border border-[#BAE6FD] rounded-2xl p-8 text-center">
        ...
        <footer className="mt-16 border-t border-gray-200 pt-8">
          ...
          <p className="text-xs text-gray-400 text-center max-w-2xl mx-auto">
            ...
            Salary data computed from active job listings in the Solar Roles database. Figures reflect listed compensation ranges and may not include bonuses, equity, or benefits. States with fewer than 3 listings for this role are excluded. Updated daily.
