...
export default async function JobsAtCityOfLaredoPage({ searchParams }: any) {
  ...
  const [{ count }, initialData] = await Promise.all([
    getCachedJobCount(params.what || 'jobs at city of laredo', params.where || '', params.salary_min),
    searchJobs({ what: params.what || 'jobs at city of laredo', where: params.where || '', results_per_page: 30, page: 1 })
