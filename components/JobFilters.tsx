      ...
      <div className="space-y-2 md:space-y-4">
        ...
        <div className="relative" ref={locationInputRef}>
          ...
          {location && (
            <button
              onClick={() => setLocation('')}
              className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground active:scale-90 transition-transform"
            >
              <X className="h-4 w-4" />
            </button>
          )}
            ...
            >
              {filteredSuggestions.map((loc, index) => (
                <button
                  ...
                  className="w-full px-4 py-2 md:py-3 text-left text-sm flex items-center gap-3 transition-all border-b border-gray-100 last:border-b-0 hover:bg-blue-50 active:bg-blue-100 active:scale-[0.98]"
                  style={{ color: '#111827' }}
                >
