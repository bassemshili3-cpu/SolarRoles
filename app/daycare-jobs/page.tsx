...
export default async function DaycareJobsPage({ searchParams }: any) {
  ...
  getMergedJobCount(params.what || 'daycare jobs', params.where || '', params.salary_min ? Number(params.salary_min) : undefined),
  searchMergedJobs({ what: params.what || 'daycare jobs', where: params.where || '', results_per_page: 30, salary_min: params.salary_min ? Number(params.salary_min) : undefined }),
])
