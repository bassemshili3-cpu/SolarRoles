...
export default async function PartTimeJobsPage({ searchParams }: any) {
  ...
  getMergedJobCount(params.what || 'part time', params.where || '', params.salary_min ? Number(params.salary_min) : undefined),
  searchMergedJobs({ what: params.what || 'part time', where: params.where || '', results_per_page: 30, salary_min: params.salary_min ? Number(params.salary_min) : undefined }),
])
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          <aside className="lg:w-80">
            <JobFilters defaultWhat="part time" />
          </aside>
