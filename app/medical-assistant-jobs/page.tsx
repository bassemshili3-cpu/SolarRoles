...
export default async function MedicalAssistantJobsPage({ searchParams }: any) {
  ...
  getMergedJobCount(params.what || 'medical assistant', params.where || '', params.salary_min ? Number(params.salary_min) : undefined),
  searchMergedJobs({ what: params.what || 'medical assistant', where: params.where || '', results_per_page: 30, salary_min: params.salary_min ? Number(params.salary_min) : undefined }),
])
  return (
    <>
      <script
