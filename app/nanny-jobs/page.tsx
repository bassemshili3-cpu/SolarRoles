...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'Nanny Jobs | Flexible Schedules & Competitive Pay',
...
const applicationTips = [
  ...
  export default async function NannyJobsPage(props: {
  ...
  getMergedJobCount(params.what || 'nanny', params.where || '', params.salary_min ? Number(params.salary_min) : undefined),
  searchMergedJobs({ what: params.what || 'nanny', where: params.where || '', results_per_page: 30, salary_min: params.salary_min ? Number(params.salary_min) : undefined }),
])
