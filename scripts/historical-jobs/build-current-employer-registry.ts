...
async function main() {
  ...
  const groups: Array<[string, readonly Seed[]]> = [
    ['jazzhr', JAZZHR_COMPANIES as unknown as readonly Seed[]],
    ['breezy', BREEZY_COMPANIES as unknown as readonly Seed[]],
    ['rippling', RIPPLING_COMPANIES as unknown as readonly Seed[]],
    ['successfactors', SUCCESSFACTORS_COMPANIES as unknown as readonly Seed[]],
    ['ashby', ASHBY_COMPANIES as unknown as readonly Seed[]],
    ['smartrecruiters', SMARTRECRUITERS_COMPANIES as unknown as readonly Seed[]],
    ['lever', LEVER_COMPANIES as unknown as readonly Seed[]],
    ['workable', WORKABLE_COMPANIES as unknown as readonly Seed[]],
    ['pinpoint', PINPOINT_COMPANIES as unknown as readonly Seed[]],
    ['jobvite', JOBVITE_COMPANIES as unknown as readonly Seed[]],
    ['oraclecloud', ORACLE_CLOUD_COMPANIES as unknown as readonly Seed[]],
    ['adp', ADP_COMPANIES as unknown as readonly Seed[]],
    ['paylocity', PAYLOCITY_COMPANIES as unknown as readonly Seed[]],
    ['paycom', PAYCOM_COMPANIES as unknown as readonly Seed[]],
    ['ukg', UKG_COMPANIES as unknown as readonly Seed[]],
    ['icims', ICIMS_COMPANIES as unknown as readonly Seed[]],
    ['workday', WORKDAY_COMPANIES as unknown as readonly Seed[]],
    ['greenhouse', GREENHOUSE_COMPANIES as unknown as readonly Seed[]],
    ['hrmdirect', HRMDIRECT_COMPANIES as unknown as readonly Seed[]],
    ['saashr', SAASHR_COMPANIES as unknown as readonly Seed[]],
  ]
