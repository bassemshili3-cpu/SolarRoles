...
export default async function HealthcareAdministrationJobsPage({ searchParams }: any) {
  ...
  getMergedJobCount(params.what || 'healthcare administration jobs', params.where || '', params.salary_min ? Number(params.salary_min) : undefined),
  searchMergedJobs({ what: params.what || 'healthcare administration jobs', where: params.where || '', results_per_page: 30, salary_min: params.salary_min ? Number(params.salary_min) : undefined }),
])
