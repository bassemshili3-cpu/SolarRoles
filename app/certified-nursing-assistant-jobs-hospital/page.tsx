...
export default async function CertifiedNursingAssistantHospitalJobsPage({ searchParams }: any) {
  ...
  const [{ count }, initialData] = await Promise.all([
    getCachedJobCount(params.what || 'certified nursing assistant hospital', params.where || '', params.salary_min),
    searchJobs({ what: params.what || 'certified nursing assistant hospital', where: params.where || '', results_per_page: 30, page: 1 })
