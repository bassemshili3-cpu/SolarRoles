...
.atitle{font-family:Inter,-apple-system,BlinkMacSystemFont,sans-serif;font-size:46px;font-weight:800;line-height:1.12;letter-spacing:-.5px;margin-bottom:24px;max-width:800px;margin-left:auto;margin-right:auto}
...
.hcap{font-family:Inter,-apple-system,BlinkMacSystemFont,sans-serif;font-size:11px;color:#999;margin-top:8px;text-align:right}
...
.pcta h3{font-family:Inter,-apple-system,BlinkMacSystemFont,sans-serif;font-size:26px;font-weight:700;color:#FAFAF7;margin:0 0 12px;border:none;padding:0}
.pcta p{font-family:Inter,-apple-system,BlinkMacSystemFont,sans-serif;font-size:16px;line-height:1.65;color:#CCC;max-width:540px;margin:0 auto 24px}
.pcta-btn{display:inline-block;font-family:Inter,-apple-system,BlinkMacSystemFont,sans-serif;font-size:13px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;background:#E8C547;color:#1A1A1A;padding:14px 36px;text-decoration:none;transition:background .2s,transform .15s;cursor:pointer}
.pcta-btn:hover{background:#F0D060;transform:translateY(-1px)}
.pcta-sm{font-family:Inter,-apple-system,BlinkMacSystemFont,sans-serif;font-size:11px;color:#777;margin-top:14px}

.pq{border-top:2px solid #1A1A1A;border-bottom:2px solid #1A1A1A;padding:28px 0;margin:40px 0;text-align:center}
.pq p{font-family:Inter,-apple-system,BlinkMacSystemFont,sans-serif;font-size:26px;font-style:italic;font-weight:500;line-height:1.4;color:#1A1A1A}

.toc{background:#F5F3EE;padding:28px 32px;margin:0 0 40px}
.toc-t{font-family:Inter,-apple-system,BlinkMacSystemFont,sans-serif;font-size:11px;font-weight:700;letter-spacing:2px;text-transform:uppercase;margin-bottom:14px;color:#1A1A1A}
.toc ol{list-style:none;counter-reset:toc;padding:0}
.toc li{counter-increment:toc;font-family:Inter,-apple-system,BlinkMacSystemFont,sans-serif;font-size:16px;line-height:1.5;padding:6px 0;color:#444}
.toc li::before{content:counter(toc, decimal-leading-zero) ".";font-family:Inter,-apple-system,BlinkMacSystemFont,sans-serif;font-size:12px;font-weight:600;color:#2B4ACB;margin-right:10px}
...
.aav{width:64px;height:64px;border-radius:50%;background:#E0DDD5;flex-shrink:0;display:flex;align-items:center;justify-content:center;font-family:Inter,-apple-system,BlinkMacSystemFont,sans-serif;font-size:24px;font-weight:700;color:#888}
...
.fbrand{font-family:Inter,-apple-system,BlinkMacSystemFont,sans-serif;font-size:24px;font-weight:900;color:#FAFAF7}
.fbrand span{color:#2B4ACB}
.flinks{display:flex;gap:24px;font-family:Inter,-apple-system,BlinkMacSystemFont,sans-serif;font-size:11px;letter-spacing:.5px;text-transform:uppercase}
.flinks a{color:#777;text-decoration:none;transition:color .2s;cursor:pointer}
.flinks a:hover{color:#FAFAF7}
.fbot{padding-top:20px;font-family:Inter,-apple-system,BlinkMacSystemFont,sans-serif;font-size:11px;color:#555;text-align:center}
  ...
  return (
    <div style={{ fontFamily: "Inter,-apple-system,BlinkMacSystemFont,sans-serif", background: "#FFFFFF", color: "#1A1A1A", minHeight: "100vh" }}>
      ...
      <article className={"ac abody fi d2" + v}>
        ...
        <p>At <a href="https://www.oh-my-job.com/jobs" target="_blank" rel="noopener noreferrer">Oh My Job</a>, we built our platform around one idea: that the right job should find you, not the other way around. We were recently featured in a dev.to article that shows exactly how AI helped one job seeker completely transform their search — read the full story <a href="https://dev.to/devidover24/im-24-i-have-a-cs-degree-and-i-cant-get-hired-heres-what-nobody-is-saying-about-gen-z-in-tech-cim" target="_blank" rel="noopener noreferrer">here</a>. Our smart matching technology analyzes your skills, experience, career goals, and preferences, then surfaces the positions that actually fit, across every major industry and metro area in the United States. No more scrolling through hundreds of irrelevant postings. No more wondering if your resume disappeared into a black hole.</p>
