...
export default async function SummerCampCounselorJobsPage({ searchParams }: any) {
  const params = await searchParams
    ...
    getMergedJobCount({ what: params.what || 'summer camp counselor', where: params.where || '' }),
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <header className="mb-10">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">
            {count > 0 ? count.toLocaleString('en-US') : 'Hundreds of'} Summer Camp Counselor Jobs Available Across the United States
          </h1>
        </header>
