...
export const metadata: Metadata = {
  ...
  description: 'Warehousing, construction, healthcare, and delivery roles that issue paychecks every Friday. Over 1,000 weekly-pay openings with shift types and hourly wages listed.',
...
export default async function WeeklyPayingJobsPage({ searchParams }: any) {
  ...
  getMergedJobCount(params.what || 'weekly paying jobs', params.where || '', params.salary_min ? Number(params.salary_min) : undefined),
  searchMergedJobs({ what: params.what || 'weekly paying jobs', where: params.where || '', results_per_page: 30, salary_min: params.salary_min ? Number(params.salary_min) : undefined }),
])
