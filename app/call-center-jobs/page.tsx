...
export default async function CallCenterJobsPage({ searchParams }: any) {
  ...
  const [{ count }, initialData] = await Promise.all([
    getCachedJobCount(params.what || 'call center', params.where || '', params.salary_min),
    searchJobs({ what: params.what || 'call center', where: params.where || '', results_per_page: 30, page: 1 })
