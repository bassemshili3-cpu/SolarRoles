...
export default async function HondaCareersPage({ searchParams }: any) {
  ...
  getMergedJobCount(params.what || 'honda', params.where || '', params.salary_min ? Number(params.salary_min) : undefined),
  searchMergedJobs({ what: params.what || 'honda', where: params.where || '', results_per_page: 30, salary_min: params.salary_min ? Number(params.salary_min) : undefined }),
])
  return (
    <>
      <script
